...
- Премиум: `gpt-4-turbo-2024-04-09`, контекстное окно 128k токенов  
...
Если загрузить изображение и добавить к нему подпись, то запрос будет сделан при помощи модели `gpt-4-vision-preview`, где в качестве контекста выступают одновременно и подпись, и изображение. Подобный запрос расходует баланс премиум токенов.  
