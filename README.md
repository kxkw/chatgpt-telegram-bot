...
Используемая модель - `gpt-3.5-turbo-1106`, лимит токенов на один запрос - 16k.
...
`/imagine` или `/i` - генерация изображения по текстовому описанию (пока только у админа)
